...
// Вам необхідно синхронізувати всі свої дії за допомогою async await (Код має бути написаний окремо)
...
async function startDay(){
    try{
        console.log(await schedule('ok'));  // or 'bad'
        console.log(await wakeUp());
        console.log(await wash());
        console.log(await breakfast('ok'));  // or 'bad'
        console.log(await procrastinate());
        console.log(await lunch());
        console.log(await homework('ok'));  // or 'bad'
        console.log(await study());
        console.log(await dinner());
        console.log(await watchYT('Legends of Korra')); // either value
